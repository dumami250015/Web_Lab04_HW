...
<%
  ...
  String studentCodeRegex = "[A-Z]{2}[0-9]{3,}";
  if (studentCode != null && !studentCode.isEmpty()) {
    if (!studentCode.matches(studentCodeRegex)) {
      String errorMsg = URLEncoder.encode("Invalid student code. Format: 2 uppercase letters + 3+ digits", "UTF-8");
      response.sendRedirect("add_student.jsp?error=" + errorMsg);
      return;
    }
  }
